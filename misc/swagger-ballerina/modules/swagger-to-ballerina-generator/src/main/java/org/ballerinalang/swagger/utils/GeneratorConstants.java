...
public class GeneratorConstants {
    ...
    public static final List<String> RESERVED_KEYWORDS = Collections.unmodifiableList(Arrays.asList("package", "import",
            "as", "public", "private", "native", "service", "resource", "function", "struct", "object", "annotation",
            "enum", "parameter", "const", "transformer", "worker", "endpoint", "bind", "xmlns", "returns", "version",
            "documentation", "deprecated", "from", "on", "group", "by", "having", "order", "where", "followed", "into",
            "set", "for", "window", "query", "expired", "current", "every", "within", "snapshot", "inner", "outer",
            "right", "left", "full", "unidirectional", "reduce", "whenever", "int", "float", "boolean", "string",
            "blob", "map", "json", "xml", "table", "stream", "any", "typedesc", "type", "future", "var", "new", "if",
            "match", "else", "foreach", "while", "next", "break", "fork", "join", "some", "all", "timeout", "try",
            "catch", "finally", "throw", "return", "transaction", "abort", "fail", "onretry", "retries", "onabort",
            "oncommit", "lengthof", "typeof", "with", "in", "lock", "untaint", "async", "await"));
